...
public class SignIn extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passSignupActivity = (EditText)findViewById(R.id.passSigninActivity);
        emailSignupActivity = (EditText)findViewById(R.id.emailSigninActivity);
    ...
    public void signinFunc(){
        ...
        mAuth.signInWithEmailAndPassword(emailSignupActivity.getText().toString(), passSignupActivity.getText().toString())
