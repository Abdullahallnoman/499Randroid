...
//                    Log.d("xxxbb", "Current data: " + snapshot.getData());
                    ...
                    Log.d("xxxbb", "Current data: " + model.getCoOneTotal());
                    Log.d("xxxbb", "Current data: " + model.getCoTwoTotal());
                    Log.d("xxxbb", "Current data: " + model.getCoThreeTotal());
                    Log.d("xxxbb", "Current data: " + model.getCoFourTotal());
